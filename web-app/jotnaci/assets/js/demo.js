demo = {
  ...
  initGoogleMaps: function() {
	  var url = "/frontofficetest1/accueilJotnaci/getPosition/"
	  var urls = "/frontofficetest1/accueilJotnaci/getPositions/"
	  var idl = $('#id').val();
	  $.get(url+idl, function(data, status){
	  var d = data.b
	  var nom = d.nomLivreur
    ...
    $.get(urls+idl, function(data, status){
