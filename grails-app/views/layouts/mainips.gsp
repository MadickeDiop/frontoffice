...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="${resource(dir: 'css', file: 'css/material-kitdpa.css?v=2.0.6')}" type="text/css">

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href="${resource(dir: 'css', file: 'demo/demodpa.css')}" type="text/css">
    <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">


</head>
<body class="index-page sidebar-collapse">
<nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg w3-container w3-blue"  color-on-scroll="100" id="sectionsNav">
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="">
                <img src="${resource(dir: 'css', file: 'img/logo.jpg')}" alt="dpa" id="logo" data-height-percentage="54" width="120px" height="54px" />
            </a>
